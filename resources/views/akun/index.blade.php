...
<title>@yield('title', 'Deteksi wajah | Akun')</title>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">{{ $users->first()->name }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Email</div>
                                        <div class="col-lg-9 col-md-8">{{ $users->first()->email }}</div>
                                    </div>
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!-- Profile Edit Form -->
                                    <form method="POST" action="{{ route('akun.update', ['id' => $users->first()->id]) }}">
                                        @csrf
                                        @method('put')
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form method="POST"
                                        action="{{ route('akun.password', ['id' => $users->first()->id]) }}">
                                        @csrf
                                        @method('put')
